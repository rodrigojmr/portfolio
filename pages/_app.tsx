    ...
    return (
      <Layout>
        <Head>
          ...
          />
          <link
            href="https://fonts.googleapis.com/css2?family=Inter:wght@700&family=Open+Sans:wght@400;700&family=Orienta&display=swap"
            rel="stylesheet"
          />
          <link
          ...
          />
          <link
            href="https://fonts.googleapis.com/css2?family=Fira+Sans:wght@400;700&family=Open+Sans:wght@400;700&family=Orienta&display=swap"
            rel="stylesheet"
          />
        </Head>
        <NextSeo
        ...
        />
        <Navbar />
        <Box as="main" minH="calc(100vh - 77px - 148px)">
          <Component {...pageProps} />
        </Box>
        <Footer />
      </Layout>
